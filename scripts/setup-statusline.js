...
const dataDir =
  arg("data-dir") || process.env.CLAUDE_BRIDGE_DIR || join(homedir(), ".claude-bridge");
...
const alreadyWrapped =
  typeof currentCommand === "string" && currentCommand.includes("bridge-statusline-tee");
...
console.log(
  "  元のコマンド: " + (alreadyWrapped ? "(前回登録時のまま保持)" : currentCommand || "(未設定)")
);
