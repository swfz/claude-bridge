...
describe('extractLocalPath', () => {
  it('extracts path from file:/// URL', () => {
    assert.equal(extractLocalPath('file:///Users/user/hoge.md'), '/Users/user/hoge.md');
  });

  it('extracts path from file:// URL (double slash)', () => {
    assert.equal(extractLocalPath('file:///home/user/test.js'), '/home/user/test.js');
  });

  it('handles WSL paths', () => {
    assert.equal(extractLocalPath('file://wsl.localhost/Ubuntu/home/user/file.txt'), '/home/user/file.txt');
  });
